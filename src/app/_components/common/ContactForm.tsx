...
const ContactForm = () => {
  return (
    <div className="flex justify-between flex-wrap md:flex-nowrap pt-20 pb-30 px-4 xl:px-0">
      {/* Left Side (Form) */}
      <div className="w-[480px] h-[576px]  flex flex-col  justify-between">
        ...
        <button
          type="submit"
          className="w-full bg-green-500 hover:bg-green-600 text-white font-medium h-[48px] rounded-md transition"
        >
          Send message
        </button>
      </div>
