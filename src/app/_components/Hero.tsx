...
const Hero = () => {
  return (
    <div className="flex items-center flex-wrap md:flex-nowrap justify-between py-20 px-4 xl:px-0">
      {/* left side */}
      <div className="w-[663px] font-serif flex  flex-col gap-4 ">
        ...
        <div className="flex items-center gap-2 pt-4">
          <button className="w-[190px] h-[50px] bg-[#3BAC43] text-white rounded-md">
            Enquire Now
          </button>
          <button className="w-[190px] h-[50px] border-[1px] border-[#9B9B9B] rounded-md">
            Contact
          </button>
        </div>
      </div>
